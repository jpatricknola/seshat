...
# Phoenix web rules (LiveView, HEEx, JS/CSS)

Framework-level rules for the web layer, extracted from the `phx.new` ruleset.
They load only when working under `lib/seshat_web/`, `assets/`, or
`test/seshat_web/`.
